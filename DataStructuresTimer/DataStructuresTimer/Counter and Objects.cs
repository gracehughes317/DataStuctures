...
namespace DataStructuresTimer
{
	...
	/*
	 * This is messy and hard to read. I will work on re-writing it all with better controls over the break and in the next week.
	 * There is currently no called back, the constant nagaging that is core to this project. That is one of the harder things to actually impliment, but I know how to do it
	 * You can re work anything you wish, again the master branch will stay clean so you can break and rebuild all you want over the break. 
	 * If you do want to push your changes up to github make sure you pushs them up as new branch, not onto the master.
	 */
	class timerArray
	{ 
	...
	class counter
	{
		...
		public void addTimer(MedicationNode timerToAdd)
		{
			...
			else
			{
				...
				timerToAdd.setPrevMed(timerScanner);
				timerToAdd.calculateEndTime();
			}
		}
